...
python train_model.py --out_folder='../output/11_7_corrected_data/' --model_type=Attention_Autoencoder --data_type=wuwei --weight_type=cell_type --neuron_num=200 --task_type=prediction --window_size=200 --predict_window_size=1 --hidden_size_1=32 --h_layers_1=0 --heads=1 --attention_layers=1 --hidden_size_2=64 --h_layers_2=0 --learning_rate=5e-5 --pos_enc_type=lookup_table --model_random_seed=22 --data_random_seed=42 --dim_key=200 --attention_activation=none --scheduler=plateau --weight_decay=1e-5