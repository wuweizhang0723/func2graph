...
# For Fiete's data
python train_model_AwC_sim.py --out_folder='../output/9_18_Fiete/' --model_type=Attention_With_Constraint_sim --data_type=Fiete --neuron_num=100 --spatial_partial_measurement=100 --task_type=prediction --window_size=100 --predict_window_size=1 --learning_rate=1e-3 --pos_enc_type=lookup_table --model_random_seed=42 --data_random_seed=42 --attention_activation=none --scheduler=cycle --constraint_loss_weight=0 --constraint_var=0.1 --causal_temporal_map=none --causal_temporal_map_diff=1 --l1_on_causal_temporal_map=0
